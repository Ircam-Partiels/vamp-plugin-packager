...
set(VPP_APPID "00000000-0000-0000-0000-000000000000" CACHE PATH "The unique ID of the project for the Windows installer")
...
set(VPP_DIR ${CMAKE_CURRENT_BINARY_DIR}/Package CACHE PATH "The installation directory of the package")
...
function(vpp_set_plugin_install target)
  ...
  elseif(WIN32)
    cmake_path(CONVERT "$ENV{PROGRAMFILES}/Vamp Plugins/" TO_CMAKE_PATH_LIST WIN_INSTALL_PATH NORMALIZE)
    vpp_set_install_imp(${target} "${WIN_INSTALL_PATH}")
  endif()
